...
# SECRET_KEY = 'django-insecure-k4!(q(dgk28lsazc&tk9-aab*5@d^r=m_h_=05=dl%r6vr5#f-'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'kite343$default',
        'USER': 'kite343',
        'PASSWORD': os.getenv('MYSQL_PASSWORD'),
        'HOST': 'kite343.mysql.pythonanywhere-services.com',
        'OPTIONS': {
